...
use crate::service::{GlobalStateService, KeyService, WalletService, WalletKinds};
    ...
    S: Storage + Clone,
{
    ...
    #[inline]
    pub fn new(transaction_obfuscation: O, transaction_handler: H, storage: S, walletkind:WalletKinds) -> Self {
        Self {

...
pub enum Command {
    ...
    Sync {
        ...
        #[structopt(
            ...
            help = "light client trusting blockash"
        )]
            ...
            Command::Sync {
                ...
                if !disable_light_client {
                    ...
                    light_client_trusting_period_seconds_user =
                        if let Some(value) = light_client_trusting_period_seconds {
                            *value
                        } else {
                ...
                let mut trusting_period = tendermint_client.genesis()?.trusting_period();

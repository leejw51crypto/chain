...
a = CLI()
print("make config")
src=a._gen(count=3, chain_id='test-ab', expansion_cap=50000000000000000,  root_path='./', hostname='localhost')
patch = jsonpatch.JsonPatch([
    ...
    {'op': 'replace', 'path': '/nodes/2/base_port', 'value':26650},
    {'op': 'replace', 'path': '/nodes/0/hostname', 'value':'chain0'},
    {'op': 'replace', 'path': '/nodes/1/hostname', 'value':'chain1'},
    {'op': 'replace', 'path': '/nodes/2/hostname', 'value':'chain2'},

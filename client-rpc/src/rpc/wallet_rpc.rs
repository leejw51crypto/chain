...
pub trait WalletRpc: Send + Sync {
    ...
    fn create_staking_address_batch(&self, request: WalletRequest, count: u32) -> Result<String>;
    ...
    fn create_transfer_address_batch(&self, request: WalletRequest, count: u32) -> Result<String>;

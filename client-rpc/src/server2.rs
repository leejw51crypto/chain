...
type AppTxBuilder = DefaultWalletTransactionBuilder<MemoryStorage, LinearFee, AppTransactionCipher>;
type AppWalletClient = DefaultWalletClient<MemoryStorage, WebsocketRpcClient, AppTxBuilder>;
...
type AppSyncerConfig =
    ObfuscationSyncerConfig<MemoryStorage, WebsocketRpcClient, AppTransactionCipher>;
